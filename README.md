...
Combined with [sceadu-fæx](https://github.com/bahrus/sceadu-fax), it can behave similarly (but certainly not identically) to the slot element within shadow DOM, though its scope may be more limited.
